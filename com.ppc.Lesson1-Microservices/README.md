...
4. You `--publish` the bot when it's ready for commercial release. The bot goes through a review process and is approved or rejected (with reasons) from Care Daily. If approved for distribution, then you will be able to submit your bot to organizations so they can be discovered and purchased for locations within these organizations.
